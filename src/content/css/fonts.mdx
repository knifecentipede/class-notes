...
<span class="advice">ADVICE:</span> provide a suitable generic font name at the end of the font stack
...
<span class="advice">ADVICE:</span> unitless value acts as a multiplier of `font-size`.
