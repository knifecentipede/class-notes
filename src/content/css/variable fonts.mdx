---
title: 'fonts: variable fonts'
---

In the past, a *typeface* was produced as multiple individual font files.
Each representing a width-weight-style combination. over 30 files!!!
Variable fonts: all those are contained in one file
...
**CAUTION:** You should only use `font-variation-settings` as a last resort, 
...
**CAUTION:** `font-stretch` property is deprecated
