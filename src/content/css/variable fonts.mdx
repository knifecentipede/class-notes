...
<span class="caution">CAUTION:</span> You should only use `font-variation-settings` as a last resort, 
...
<span class="caution">CAUTION:</span> `font-stretch` property is deprecated
